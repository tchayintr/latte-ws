...
DATA_ROOT_DIR=.
EXT_DIC_DATA=data/dict/bcc-icwb2-jieba.vocab.sl
NUM_GPUS=1
BATCH_SIZE=16
MAX_EPOCHS=20
PRETRAINED_MODEL=data/ptm/latte-mc-bert-bert-chinese-ws
# PRETRAINED_MODEL=yacht/latte-mc-bert-base-chinese-ws
SAVE_DIR=models/zh
MODEL_VERSION=0
BERT_MODE=sum
LR=1e-3
...
# ctb6
TRAIN_DATA=(
    data/zh/ctb6/ctb6.train.seg.sl
)
VALID_DATA=(
    data/zh/ctb6/ctb6.valid.seg.sl
)
TEST_DATA=(
    data/zh/ctb6/ctb6.test.seg.sl
)
MODEL_NAME=(
    ctb6.latte-mc-bert
)
